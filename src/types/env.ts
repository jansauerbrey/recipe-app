...
export function getConfig(): AppConfig {
  return {
    ...
    ALLOWED_FILE_TYPES: (Deno.env.get('ALLOWED_FILE_TYPES') || 'image/jpeg,image/png,image/gif')
      .split(','),
    ...
    // API Documentation
    OPENAPI_SPEC_PATH: Deno.env.get('OPENAPI_SPEC_PATH') || './src/openapi/openapi.yaml',
  };
}
